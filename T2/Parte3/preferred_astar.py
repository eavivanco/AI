...
class PrefAstar:
    ...
    def estimate_suboptimality(self):
        ...
        self.union.extend(self.open)
        self.union.extend(self.preferred)
        for nodo in self.union:
            f_val = nodo.h[0] + nodo.g
            if min_f == None:
                min_f = f_val
            else:
                if f_val < min_f:
    ...
    def fvalue(self, g, h):
        return g + self.weight * h  # Optimízame, dado lo que aprendiste en Parte 1!!!
